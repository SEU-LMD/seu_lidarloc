...
int main(int argc, char **argv) {
    ...
    auto cloud_callback = std::bind(&DRCalibManager::CloudCallback, &dr_calib_manager,std::placeholders::_1);
    ...
    pubsub->addSubscriber(SensorConfig::gpsTopic, DataType::WHEEL, dr_callback);
