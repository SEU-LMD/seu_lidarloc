// Generated by gencpp from file lio_sam_6axis/cloud_info.msg
// DO NOT EDIT!


#ifndef LIO_SAM_6AXIS_MESSAGE_CLOUD_INFO_H
#define LIO_SAM_6AXIS_MESSAGE_CLOUD_INFO_H
...
struct cloud_info_
{
  ...
  typedef boost::shared_ptr< ::lio_sam_6axis::cloud_info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::lio_sam_6axis::cloud_info_<ContainerAllocator> const> ConstPtr;

}; // struct cloud_info_

typedef ::lio_sam_6axis::cloud_info_<std::allocator<void> > cloud_info;

typedef boost::shared_ptr< ::lio_sam_6axis::cloud_info > cloud_infoPtr;
typedef boost::shared_ptr< ::lio_sam_6axis::cloud_info const> cloud_infoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::lio_sam_6axis::cloud_info_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::lio_sam_6axis::cloud_info_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct HasHeader< ::lio_sam_6axis::cloud_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lio_sam_6axis::cloud_info_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::lio_sam_6axis::cloud_info_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::lio_sam_6axis::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "lio_sam_6axis/cloud_info";
  }
...
template<class ContainerAllocator>
struct Definition< ::lio_sam_6axis::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Cloud Info\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::lio_sam_6axis::cloud_info_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::lio_sam_6axis::cloud_info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::lio_sam_6axis::cloud_info_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
