...
struct WheelSpeedInfo {
    ...
    {
        return (fabs(wheelSpeedMps - t.wheelSpeedMps) < FLT_EPSILON) && (wheelCount == t.wheelCount) && (wheelDirection == t.wheelDirection) && (wheelSpeedMpsValid == t.wheelSpeedMpsValid) && (wheelCountValid == t.wheelCountValid) && (wheelDirectionValid == t.wheelDirectionValid);
    }
};
} // namespace actcompensation
} // namespace ara
