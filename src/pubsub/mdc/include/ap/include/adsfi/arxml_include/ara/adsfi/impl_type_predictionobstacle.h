...
struct PredictionObstacle {
    ...
    {
        return (object == t.object) && (gpsTime == t.gpsTime) && (fabs(predictedPeriod - t.predictedPeriod) < FLT_EPSILON) && (trajectory == t.trajectory) && (intent == t.intent) && (priority == t.priority) && (isStatic == t.isStatic) && (feature == t.feature);
    }
};
} // namespace adsfi
} // namespace ara
