...
#ifndef MDC_SSM_IMPL_TYPE_PEPSSWITCH_H
#define MDC_SSM_IMPL_TYPE_PEPSSWITCH_H
#include <cfloat>
#include <cmath>
...
struct PepsSwitch {
    ...
    bool operator == (const ::mdc::ssm::PepsSwitch& t) const
    {
...
#endif // MDC_SSM_IMPL_TYPE_PEPSSWITCH_H
