...
private:
    ...
    void ConstructSkeleton(ara::com::MethodCallProcessingMode mode)
    {
        ...
        ara::core::Result<void> resultTrajetoryPredictionEvent = skeletonAdapter->InitializeEvent(TrajetoryPredictionEvent);
...
public:
    ...
    explicit TrajetoryPredictionInterfaceSkeleton(ara::com::InstanceIdentifier instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceId, mode)),
          TrajetoryPredictionEvent(skeletonAdapter->GetSkeleton(), events::TrajetoryPredictionEventId){
        ConstructSkeleton(mode);
    }

    explicit TrajetoryPredictionInterfaceSkeleton(ara::core::InstanceSpecifier instanceSpec,
                           ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    explicit TrajetoryPredictionInterfaceSkeleton(ara::com::InstanceIdentifierContainer instanceContainer,
                           ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    TrajetoryPredictionInterfaceSkeleton(TrajetoryPredictionInterfaceSkeleton&& other) = default;
    TrajetoryPredictionInterfaceSkeleton& operator=(TrajetoryPredictionInterfaceSkeleton&& other) = default;
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            events::TrajetoryPredictionEvent TrajetoryPredictionEvent(preSkeletonAdapter->GetSkeleton(), events::TrajetoryPredictionEventId);
