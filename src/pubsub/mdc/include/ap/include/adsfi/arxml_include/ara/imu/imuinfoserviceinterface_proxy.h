...
public:
    ...
    explicit ImuInfoServiceInterfaceProxy(const vrtf::vcc::api::types::HandleType &handle)
        : proxyAdapter(std::make_unique<ara::com::internal::proxy::ProxyAdapter>(::ara::imu::ImuInfoServiceInterface::ServiceIdentifier, handle)),
          mdcEvent(proxyAdapter->GetProxy(), events::mdcEventId, proxyAdapter->GetHandle(), ::ara::imu::ImuInfoServiceInterface::ServiceIdentifier){
        }
    ...
    ImuInfoServiceInterfaceProxy(ImuInfoServiceInterfaceProxy&& other) = default;
    ImuInfoServiceInterfaceProxy& operator=(ImuInfoServiceInterfaceProxy&& other) = default;
