...
public:
    ...
    explicit RadarTrackServiceInterfaceProxy(const vrtf::vcc::api::types::HandleType &handle)
        : proxyAdapter(std::make_unique<ara::com::internal::proxy::ProxyAdapter>(::ara::rtrack::RadarTrackServiceInterface::ServiceIdentifier, handle)),
          mdcEvent(proxyAdapter->GetProxy(), events::mdcEventId, proxyAdapter->GetHandle(), ::ara::rtrack::RadarTrackServiceInterface::ServiceIdentifier){
        }
    ...
    RadarTrackServiceInterfaceProxy(RadarTrackServiceInterfaceProxy&& other) = default;
    RadarTrackServiceInterfaceProxy& operator=(RadarTrackServiceInterfaceProxy&& other) = default;
