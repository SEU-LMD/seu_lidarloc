...
public:
    ...
    explicit TrafficLightInterfaceProxy(const vrtf::vcc::api::types::HandleType &handle)
        : proxyAdapter(std::make_unique<ara::com::internal::proxy::ProxyAdapter>(::mdc::trafficlight::TrafficLightInterface::ServiceIdentifier, handle)),
          TrafficLightArrayEvent(proxyAdapter->GetProxy(), events::TrafficLightArrayEventId, proxyAdapter->GetHandle(), ::mdc::trafficlight::TrafficLightInterface::ServiceIdentifier){
        }
    ...
    TrafficLightInterfaceProxy(TrafficLightInterfaceProxy&& other) = default;
    TrafficLightInterfaceProxy& operator=(TrafficLightInterfaceProxy&& other) = default;
