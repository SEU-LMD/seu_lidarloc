...
public:
    ...
    explicit ActCompensationServiceInterfaceProxy(const vrtf::vcc::api::types::HandleType &handle)
        : proxyAdapter(std::make_unique<ara::com::internal::proxy::ProxyAdapter>(::ara::actcompensation::ActCompensationServiceInterface::ServiceIdentifier, handle)),
          mdcEvent(proxyAdapter->GetProxy(), events::mdcEventId, proxyAdapter->GetHandle(), ::ara::actcompensation::ActCompensationServiceInterface::ServiceIdentifier){
        }
    ...
    ActCompensationServiceInterfaceProxy(ActCompensationServiceInterfaceProxy&& other) = default;
    ActCompensationServiceInterfaceProxy& operator=(ActCompensationServiceInterfaceProxy&& other) = default;
