...
private:
    ...
    void ConstructSkeleton(ara::com::MethodCallProcessingMode mode)
    {
        ...
        ara::core::Result<void> resultReportFault = skeletonAdapter->InitializeMethod<ara::core::Future<ReportFaultOutput>>(methods::ReportFaultId);
...
public:
    ...
    struct ReportFaultOutput {
        ...
        bool operator == (const ReportFaultOutput& t) const
        {
    ...
    explicit FmReportEventServiceSkeleton(ara::com::InstanceIdentifier instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::mdc::fm::FmReportEventService::ServiceIdentifier, instanceId, mode)),
          ReportFaultHandle(skeletonAdapter->GetSkeleton(), methods::ReportFaultId){
        ConstructSkeleton(mode);
    }

    explicit FmReportEventServiceSkeleton(ara::core::InstanceSpecifier instanceSpec,
                           ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    explicit FmReportEventServiceSkeleton(ara::com::InstanceIdentifierContainer instanceContainer,
                           ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    FmReportEventServiceSkeleton(FmReportEventServiceSkeleton&& other) = default;
    FmReportEventServiceSkeleton& operator=(FmReportEventServiceSkeleton&& other) = default;
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            initResult = preSkeletonAdapter->InitializeMethod<ara::core::Future<ReportFaultOutput>>(methods::ReportFaultId);
    ...
    void OfferService()
    {
        skeletonAdapter->RegisterMethod(&FmReportEventServiceSkeleton::ReportFault, *this, methods::ReportFaultId);
