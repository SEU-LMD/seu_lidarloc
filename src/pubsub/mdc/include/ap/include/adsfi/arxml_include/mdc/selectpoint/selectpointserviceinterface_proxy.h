...
namespace events {
    ...
    static constexpr ara::com::internal::EntityId SelectPointEventId = 3640; //SelectPointEvent_event_hash
}
...
public:
    ...
    explicit SelectPointServiceInterfaceProxy(const vrtf::vcc::api::types::HandleType &handle)
        : proxyAdapter(std::make_unique<ara::com::internal::proxy::ProxyAdapter>(::mdc::selectpoint::SelectPointServiceInterface::ServiceIdentifier, handle)),
          SelectPointEvent(proxyAdapter->GetProxy(), events::SelectPointEventId, proxyAdapter->GetHandle(), ::mdc::selectpoint::SelectPointServiceInterface::ServiceIdentifier){
        }
    ...
    SelectPointServiceInterfaceProxy(SelectPointServiceInterfaceProxy&& other) = default;
    SelectPointServiceInterfaceProxy& operator=(SelectPointServiceInterfaceProxy&& other) = default;
