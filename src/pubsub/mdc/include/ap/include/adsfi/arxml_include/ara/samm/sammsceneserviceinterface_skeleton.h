...
namespace events
{
    ...
    static constexpr ara::com::internal::EntityId SammSceneEventId = 2121; //SammSceneEvent_event_hash
}
...
private:
    ...
    void ConstructSkeleton(ara::com::MethodCallProcessingMode mode)
    {
        ...
        ara::core::Result<void> resultSammSceneEvent = skeletonAdapter->InitializeEvent(SammSceneEvent);
...
public:
    ...
    explicit SammSceneServiceInterfaceSkeleton(ara::com::InstanceIdentifier instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::ara::samm::SammSceneServiceInterface::ServiceIdentifier, instanceId, mode)),
          SammSceneEvent(skeletonAdapter->GetSkeleton(), events::SammSceneEventId){
        ConstructSkeleton(mode);
    }

    explicit SammSceneServiceInterfaceSkeleton(ara::core::InstanceSpecifier instanceSpec,
                           ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    explicit SammSceneServiceInterfaceSkeleton(ara::com::InstanceIdentifierContainer instanceContainer,
                           ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    SammSceneServiceInterfaceSkeleton(SammSceneServiceInterfaceSkeleton&& other) = default;
    SammSceneServiceInterfaceSkeleton& operator=(SammSceneServiceInterfaceSkeleton&& other) = default;
        ...
        ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::ara::samm::SammSceneServiceInterface::ServiceIdentifier, instanceId, mode);
        ...
        ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::ara::samm::SammSceneServiceInterface::ServiceIdentifier, instanceSpec, mode);
        return PreConstructResult(preSkeletonAdapter, mode);
    }
        ...
        ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::ara::samm::SammSceneServiceInterface::ServiceIdentifier, instanceIdContainer, mode);
        return PreConstructResult(preSkeletonAdapter, mode);
    }
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            events::SammSceneEvent SammSceneEvent(preSkeletonAdapter->GetSkeleton(), events::SammSceneEventId);
            initResult = preSkeletonAdapter->InitializeEvent(SammSceneEvent);
