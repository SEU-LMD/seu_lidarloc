...
#ifndef MDC_SSM_IMPL_TYPE_MODESWITCH_H
#define MDC_SSM_IMPL_TYPE_MODESWITCH_H
#include <cfloat>
#include <cmath>
...
struct ModeSwitch {
    ...
    bool operator == (const ::mdc::ssm::ModeSwitch& t) const
    {
...
#endif // MDC_SSM_IMPL_TYPE_MODESWITCH_H
