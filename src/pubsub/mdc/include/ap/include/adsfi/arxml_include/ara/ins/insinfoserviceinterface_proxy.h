...
public:
    ...
    explicit InsInfoServiceInterfaceProxy(const vrtf::vcc::api::types::HandleType &handle)
        : proxyAdapter(std::make_unique<ara::com::internal::proxy::ProxyAdapter>(::ara::ins::InsInfoServiceInterface::ServiceIdentifier, handle)),
          mdcEvent(proxyAdapter->GetProxy(), events::mdcEventId, proxyAdapter->GetHandle(), ::ara::ins::InsInfoServiceInterface::ServiceIdentifier){
        }
    ...
    InsInfoServiceInterfaceProxy(InsInfoServiceInterfaceProxy&& other) = default;
    InsInfoServiceInterfaceProxy& operator=(InsInfoServiceInterfaceProxy&& other) = default;
