...
#define PG_VERSION "10.16 (Ubuntu 10.16-0ubuntu0.18.04.1)"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 100016

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 10.16 (Ubuntu 10.16-0ubuntu0.18.04.1) on aarch64-unknown-linux-gnu, compiled by gcc (Ubuntu/Linaro 7.5.0-3ubuntu1~18.04) 7.5.0, 64-bit"
