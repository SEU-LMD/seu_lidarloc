...
struct E2EConfigInfo {
    ...
    ::rtf::stdtype::uint32_t minDataLength = 0;
    ::rtf::stdtype::uint32_t maxDataLength = 0;
    ::rtf::stdtype::uint16_t dataLength = 0;
    ::rtf::stdtype::uint32_t maxDeltaCounter = 0;
    ::rtf::maintaind::E2EDataIDMode dataIdMode = E2EDataIDMode::E2E_DATAID_NIBBLE;
    ::rtf::stdtype::uint8_t windowSizeValid = 0;
    ::rtf::stdtype::uint8_t minOkStateInit = 0;
    ::rtf::stdtype::uint8_t maxErrorStateInit = 0;
    ::rtf::stdtype::uint8_t minOkStateValid = 0;
    ::rtf::stdtype::uint8_t maxErrorStateValid = 0;
    ::rtf::stdtype::uint8_t minOkStateInvalid = 0;
    ::rtf::stdtype::uint8_t maxErrorStateInvalid = 0;
    ::rtf::stdtype::uint8_t windowSizeInit = 0;
    ::rtf::stdtype::uint8_t windowSizeInvalid = 0;
    bool clearToInvalid = false;

    ::rtf::stdtype::uint32_t offset = 0;
    static bool IsPlane()
    {
        return false;
    }
    ...
    bool operator == (const ::rtf::maintaind::E2EConfigInfo& t) const
    {
