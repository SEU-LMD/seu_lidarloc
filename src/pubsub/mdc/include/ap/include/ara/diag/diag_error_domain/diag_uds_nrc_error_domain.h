 ...
 */
#ifndef ARA_DIAG_UDS_ERROR_DOMAIN_H
#define ARA_DIAG_UDS_ERROR_DOMAIN_H
#include <cstdint>
...
static const ara::core::Map<DiagUdsNrcErrc, char const *> g_nrcToString = {
...
public:
    ...
    virtual void ThrowAsException(const ara::core::ErrorCode&) const noexcept override {}
private:
    constexpr static ara::core::ErrorDomain::IdType kId = 0x80000000000000FDU; // need to design
};
...
constexpr ara::core::ErrorDomain const& GetDiagUdsErrorDomain()
{
    return internal::g_diagUdsErrorDomain;
}

constexpr ara::core::ErrorCode MakeErrorCode(const DiagUdsNrcErrc code,
    const ara::core::ErrorDomain::SupportDataType supportData = ara::core::ErrorDomain::SupportDataType()) noexcept
{
    return ara::core::ErrorCode(static_cast<ara::core::ErrorDomain::CodeType>(code), GetDiagUdsErrorDomain(),
        supportData);
}
}
}
