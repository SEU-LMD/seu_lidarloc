...
const int32_t VPC_OUT_WIDTH_STRIDE = 128;
const int32_t VPC_OUT_HIGH_STRIDE = 16;

// vpc param
const int32_t vpc_default_width = 16;
const int32_t vpc_default_high = 16;
const int32_t vpc_default_bit_width = 8;
const int32_t vpc_max_width = 4096;
const int32_t vpc_min_width = 16;
const int32_t vpc_max_high = 8192;
const int32_t vpc_min_high = 16;
const int32_t vpc_default_stride = 128;
const int32_t vpc_default_high_stride = 16;
const int32_t vpc_default_H_max = 0x1fff;
const int32_t vpc_default_H_min = 0;
const int32_t vpc_default_V_max = 0x1fff;
const int32_t vpc_default_V_min = 0;
const int32_t vpc_rdma_channel = 0;
const int32_t vpc_cvdr_channel = 1;
const int32_t collage_num = 4;
