...
public:
    ...
    explicit ObjectArrayInterfaceProxy(const vrtf::vcc::api::types::HandleType &handle)
        : proxyAdapter(std::make_unique<ara::com::internal::proxy::ProxyAdapter>(::mdc::adsfi::ObjectArrayInterface::ServiceIdentifier, handle)),
          ObjectArrayEvent(proxyAdapter->GetProxy(), events::ObjectArrayEventId, proxyAdapter->GetHandle(), ::mdc::adsfi::ObjectArrayInterface::ServiceIdentifier){
        }
    ...
    ObjectArrayInterfaceProxy(ObjectArrayInterfaceProxy&& other) = default;
    ObjectArrayInterfaceProxy& operator=(ObjectArrayInterfaceProxy&& other) = default;
