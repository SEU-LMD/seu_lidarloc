...
public:
    ...
    explicit ChassisReportServiceInterfaceProxy(const vrtf::vcc::api::types::HandleType &handle)
        : proxyAdapter(std::make_unique<ara::com::internal::proxy::ProxyAdapter>(::ara::chassis::ChassisReportServiceInterface::ServiceIdentifier, handle)),
          mdcEvent(proxyAdapter->GetProxy(), events::mdcEventId, proxyAdapter->GetHandle(), ::ara::chassis::ChassisReportServiceInterface::ServiceIdentifier){
        }
    ...
    ChassisReportServiceInterfaceProxy(ChassisReportServiceInterfaceProxy&& other) = default;
    ChassisReportServiceInterfaceProxy& operator=(ChassisReportServiceInterfaceProxy&& other) = default;
