...
public:
    ...
    explicit EgoTrajectoryServiceInterfaceProxy(const vrtf::vcc::api::types::HandleType &handle)
        : proxyAdapter(std::make_unique<ara::com::internal::proxy::ProxyAdapter>(::ara::egotrajectory::EgoTrajectoryServiceInterface::ServiceIdentifier, handle)),
          EgoTrajectoryEvent(proxyAdapter->GetProxy(), events::EgoTrajectoryEventId, proxyAdapter->GetHandle(), ::ara::egotrajectory::EgoTrajectoryServiceInterface::ServiceIdentifier){
        }
    ...
    EgoTrajectoryServiceInterfaceProxy(EgoTrajectoryServiceInterfaceProxy&& other) = default;
    EgoTrajectoryServiceInterfaceProxy& operator=(EgoTrajectoryServiceInterfaceProxy&& other) = default;
