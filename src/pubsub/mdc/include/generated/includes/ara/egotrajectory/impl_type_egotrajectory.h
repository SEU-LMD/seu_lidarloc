...
struct EgoTrajectory {
    ...
    {
        return (header == t.header) && (locationState == t.locationState) && (pose == t.pose) && (velocity == t.velocity) && (acceleration == t.acceleration) && (fabs(trajectoryLength - t.trajectoryLength) < FLT_EPSILON) && (fabs(trajectoryPeriod - t.trajectoryPeriod) < FLT_EPSILON) && (trajectoryPoints == t.trajectoryPoints) && (wayPoints == t.wayPoints) && (isReplanning == t.isReplanning) && (gear == t.gear) && (routingHeader == t.routingHeader) && (selfLaneId == t.selfLaneId) && (trajectoryType == t.trajectoryType) && (targetLaneId == t.targetLaneId) && (estop == t.estop) && (turnLight == t.turnLight) && (isHold == t.isHold);
    }
};
} // namespace egotrajectory
} // namespace ara
